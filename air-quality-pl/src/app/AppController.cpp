...
AppController::AppController(QObject* parent)
  ...
  connect(&m_gios, &GiosClient::measurementsReady, this, [this](int sensorId, QString paramCode, QVariantList points) {
    try {
      ...
      // Oprócz listy dla QML trzymamy też serię domenową używaną przez analizę i bazę lokalną.
...
void AppController::loadHistory(int sensorId, const QString& fromIso, const QString& toIso) {
  try {
    ...
    // Historia lokalna jest zamieniana na ten sam format punktów, z którego korzysta wykres online.
    QVariantList list;
